...
const { When, Then } = require("../../node/node_modules/cucumber");
const search = new searchPage_1.SearchPageObject();
When(/^I type "(.*?)"$/, (text) => __awaiter(void 0, void 0, void 0, function* () {
    yield search.searchTextBox.sendKeys(text);
}));
When(/^I click on search button$/, () => __awaiter(void 0, void 0, void 0, function* () {
    yield protractor_1.browser.actions().sendKeys(protractor_1.protractor.Key.ENTER).perform();
}));
Then(/^I click on google logo$/, () => __awaiter(void 0, void 0, void 0, function* () {
